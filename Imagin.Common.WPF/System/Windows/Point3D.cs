...
#pragma warning disable 1591
        ...
        public static implicit operator Point3D(Media.Media3D.Point3D right) => new Point3D(right);

        public static implicit operator Media.Media3D.Point3D(Point3D right) => new Media.Media3D.Point3D(right.X, right.Y, right.Z);
#pragma warning disable 1591
