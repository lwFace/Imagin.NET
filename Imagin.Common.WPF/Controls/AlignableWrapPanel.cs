...
namespace Imagin.Common.Controls
{
    ...
    public class AlignableWrapPanel : Panel
    {
        ...
        static void OnOrientationChanged(DependencyObject i, DependencyPropertyChangedEventArgs e) => ((AlignableWrapPanel)i).orientation = new OldNew<Orientation>(e).New;
