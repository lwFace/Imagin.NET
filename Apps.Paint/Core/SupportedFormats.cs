    ...
    public class SupportedFormats
    {
        ...
        public static IEnumerable<FileFormat> Formats
        {
            get
            {
                ...
                (
                    new FileFormat(Document.DefaultExtension, true, true),
                    //----------------------------------------------------------------
        ...
        public static bool IsReadable(string extension)
            => Formats.Where(i => i.Extension == extension).FirstOrDefault().Readable;

        public static bool IsWritable(string extension)
            => Formats.Where(i => i.Extension == extension).FirstOrDefault().Writable;
    }
}
