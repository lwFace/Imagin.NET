...
namespace System.Windows.Media.Imaging
{
    ...
    public unsafe static partial class WriteableBitmapExtensions
    {
        ...
        private static int Blend(BlendModes? mode, int pixel, int sa, int sr, int sg, int sb)
        {
            int destPixel = pixel;
            ...
            var color1 = Convert(destPixel);
            var color2 = Convert((sa << 24) | (sr << 16) | (sg << 8) | sb);
            var color3 = VisualLayer.Blend(mode, color1, color2);
