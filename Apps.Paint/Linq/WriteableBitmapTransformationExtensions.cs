...
namespace System.Windows.Media.Imaging
{
    public unsafe static partial class WriteableBitmapExtensions
    {
        ...
        public static WriteableBitmap Resize(this WriteableBitmap bmp, int width, int height, Interpolations interpolation)
        {
            using (var srcContext = bmp.GetBitmapContext(ReadWriteMode.ReadOnly))
            {
        ...
        public static int[] Resize(BitmapContext srcContext, int widthSource, int heightSource, int width, int height, Interpolations interpolation)
        {
        ...
        /// <param name="interpolation">The interpolation method that should be used.</param>
        /// <returns>A new bitmap that is a resized version of the input.</returns>
        public static int[] Resize(int* pixels, int widthSource, int heightSource, int width, int height, Interpolations interpolation)
        {
